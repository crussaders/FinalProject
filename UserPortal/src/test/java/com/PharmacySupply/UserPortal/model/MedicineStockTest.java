...
class MedicineStockTest {
	...
	public void AllArgConstTest() {
		MedicineStock stock = new MedicineStock(1,"Crocin","digoxin","General","Healthy Pharmacy", new Date(2022 - 9 - 12), 10);
	...
	public void testToString() {
		assertEquals("MedicineStock(id=" + 1 + ", name=" + medicineStock.getName() + ", chemicalComposition=" + medicineStock.getChemicalComposition() + ", targetAilment=" + medicineStock.getTargetAilment() + ", pharmacyName=" + medicineStock.getPharmacyName() + ", dateOfExpiry=" + medicineStock.getDateOfExpiry() + ", numberOfTabletInStock=" + medicineStock.getNumberOfTabletsInStock() +")", medicineStock.toString());
	}
