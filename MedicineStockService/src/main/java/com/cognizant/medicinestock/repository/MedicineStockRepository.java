...
/* This is a MedicineStockRepository interface extending JpaRepository and performs querying in order to fetch the specific data */  
@Repository
public interface MedicineStockRepository extends JpaRepository<MedicineStock, Integer>{

	/* This query will give all the details based on given target ailment */
	...
	/* This query will give number of tablets in stock based on the medicine name */
	...
	/* This query will update tablets stock count  based on given given name */
	@Transactional
